...
i686-elf-gcc -T ./linker/kern.ld -o ./out/KRNL.LIG -O2 -ffreestanding -nostdlib ./out/krnlasm.obj ./out/string.obj ./out/term.obj ./out/mem.obj ./out/command.obj ./out/ckern.obj -lgcc
